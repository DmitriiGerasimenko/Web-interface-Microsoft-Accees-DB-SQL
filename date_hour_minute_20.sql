...
AND ((t01.Дата = t15.Дата) and hour(t01.Время) = hour(t15.Время) and minute(t01.Время) = minute(t15.Время))
AND ((t01.Дата = t16.Дата) and hour(t01.Время) = hour(t16.Время) and minute(t01.Время) = minute(t16.Время))
AND ((t01.Дата = t17.Дата) and hour(t01.Время) = hour(t17.Время) and minute(t01.Время) = minute(t17.Время))
AND ((t01.Дата = t18.Дата) and hour(t01.Время) = hour(t18.Время) and minute(t01.Время) = minute(t18.Время))
AND ((t01.Дата = t19.Дата) and hour(t01.Время) = hour(t19.Время) and minute(t01.Время) = minute(t19.Время))
AND ((t01.Дата = t20.Дата) and hour(t01.Время) = hour(t20.Время) and minute(t01.Время) = minute(t20.Время))
